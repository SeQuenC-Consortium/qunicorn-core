...
class AzureQuantumMachine(QAM[AzureJob]):
    ...
    def get_result(self, execute_response: AzureJob) -> QAMExecutionResult:
        ...
        # TODO: as of https://github.com/microsoft/qdk-python/blob/4d6f7f75c8c7d8467f87936b1aaef449de1e0bf6/azure
        #  -quantum/azure/quantum/target/rigetti/result.py#L47
