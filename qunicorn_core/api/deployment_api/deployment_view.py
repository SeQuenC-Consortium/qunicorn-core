...
class JobsByDeploymentView(MethodView):
    ...
    def get(self, deployment_id: str, jwt_subject: Optional[str]):
        ...
        return jobmanager_service.get_jobs_by_deployment_id(deployment_id, user_id=jwt_subject)
    ...
    def delete(self, deployment_id: str, jwt_subject: Optional[str]):
        ...
        return jobmanager_service.delete_jobs_by_deployment_id(deployment_id, user_id=jwt_subject)
