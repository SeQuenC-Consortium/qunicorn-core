...
from ..api_models.deployment_dtos import DeploymentDto
...
class DeploymentIDView(MethodView):
    ...
    @DEPLOYMENT_API.response(HTTPStatus.OK, DeploymentDto())
    def get(self):
        """Get pre-deployed job definition list."""

        pass

    @DEPLOYMENT_API.arguments(DeploymentDto(), location="json")
    @DEPLOYMENT_API.response(HTTPStatus.OK, DeploymentDto())
